---
layout: single
permalink: /HiOSD/HiOSD_Chinese
title: "基于优化的高阶收缩二聚体鞍点动力学(HiOSD)"
sidebar:
    nav: Theory_Chinese
toc: true
toc_sticky: true
...
![计算 $k$ 阶鞍点的 HiOSD 方法](./计算 $k$ 阶鞍点的 HiOSD 方法.png)
...
![计算 $k$ 阶鞍点的 HiOSD-LOBPCG 方法](./计算 $k$ 阶鞍点的 HiOSD-LOBPCG 方法.png)
