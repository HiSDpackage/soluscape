...
def LandscapeRun(instance):
    ...
    while k >= 0:
        ...
        if instance.calHiSD.flag:
            ...
            if whetherinlist:
                ...
                if (
                        instance.BeginID != -1 and (instance.BeginID
                ...
                if instance.SaveTrajectory:
                    ...
                    instance.DetailRecord.append(
                        [instance.saddleind, instance.BeginID]
                    )
    ...
    while tempList:
        ...
        for j in range(tempsearchinitial[2]-1,
            ...
            if j > 0:
                ...
                for r in range(len(all_combinations)):
                    ...
                    for per in PerturbationList:
                        ...
                        print("\n")
                        print(f"From saddle point (index-{tempsearchinitial[2]}, ID-{tempsearchinitial[0]}) search index-{j}:\n" + '-' * 30)
                        print("\n")
                        instance.calHiSD.run()
                        ...
                        if instance.calHiSD.finalindex > j:
                            print("Sorry! Because of the relaxed abort criteria, we find a saddle point with higher index.")
                            continue
